        ...
        if let Key(key) = event::read().map_err(|err| EmulationError::UnknownInput)? {
            ...
            if key.kind == KeyEventKind::Press {
                match key.code {
                    ...
                    KeyCode::Char('4') => keypad_state[3] = true,

                    KeyCode::Char('q') => keypad_state[4] = true,
                    KeyCode::Char('w') => keypad_state[5] = true,
                    KeyCode::Char('e') => keypad_state[6] = true,
                    KeyCode::Char('r') => keypad_state[7] = true,

                    KeyCode::Char('a') => keypad_state[8] = true,
                    KeyCode::Char('s') => keypad_state[9] = true,
                    KeyCode::Char('d') => keypad_state[10] = true,
                    KeyCode::Char('f') => keypad_state[11] = true,

                    KeyCode::Char('z') => keypad_state[12] = true,
                    KeyCode::Char('x') => keypad_state[13] = true,
                    KeyCode::Char('c') => keypad_state[14] = true,
